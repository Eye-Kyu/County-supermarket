      ...
      <div className="max-w-3xl mx-auto">
        <div ref={contentRef}>
          ...
          <p className="text-gray-600 leading-relaxed text-sm sm:text-base mb-4">
            ...
            abandoning what built us. We&apos;re protecting it, by widening what
            stands beside it.
          </p>
          <p className="text-gray-600 leading-relaxed text-sm sm:text-base mb-8">
            ...
            past year, who kept shopping, kept trusting, kept showing up, there
            isn&apos;t really a way to say thank you that&apos;s big enough.
            There is a County tomorrow because there were County customers
            yesterday. That is the whole equation.
          </p>
