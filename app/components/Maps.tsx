...
export default function Maps() {
  ...
  return (
    <div className="">
      ...
      <section className="flex flex-col-reverse md:flex-row w-full min-h-screen px-4 py-8 sm:px-6 md:px-12 gap-8 md:gap-12">
        {/* Locations */}
        ...
        {/* Map */}
        <div className="w-full md:w-1/2 h-72 sm:h-80 md:h-auto rounded-xl overflow-hidden shadow-lg bg-white">
          <iframe
            src={mapSrc}
