...
export default function CareersExperience() {
  ...
  return (
    <main>
            ...
            {careersValues.map((value, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-bold text-blue-950 text-base mb-2">
                    {value.title}
                  </h3>
      ...
      <section
        id="roles"
        className="bg-gray-50 py-16 sm:py-20 px-4 sm:px-6 md:px-16"
      >
        <div className="max-w-7xl mx-auto">
          <p className="text-xs font-semibold uppercase tracking-widest text-orange-500 mb-3">
            Current Openings
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-blue-950 mb-4 text-center">
          ...
          <div className="mb-10 rounded-2xl border border-orange-100 bg-white p-5 text-sm text-gray-600 shadow-sm">
            <p className="font-semibold text-blue-950">
              Applications take less than two minutes.
            </p>
            <p className="mt-1">
              Simply choose a role, upload your CV, and submit your application
              online.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {jobRoles.map((role) => (
              <JobCard
                key={role.id}
                job={role}
                onApply={openSpecificApplication}
              />
            ))}
          </div>
*/}
      ...
      <section className="bg-blue-950 py-14 px-4 text-center">
        ...
        <p className="text-white/50 text-sm mb-8 max-w-md mx-auto leading-relaxed">
          We grow fast. If you believe in what we&apos;re building, send us your
          CV and we&apos;ll keep you in mind for new openings.
        </p>
        <button
          type="button"
